...
<acme:form>
	...
	<acme:form-moment code="anonymous.duty.form.label.startPeriod" path="startPeriod"/>
	<acme:form-moment code="anonymous.duty.form.label.endPeriod" path="endPeriod"/>
	<acme:form-double code="anonymous.duty.form.label.workload" path="workload"/>
