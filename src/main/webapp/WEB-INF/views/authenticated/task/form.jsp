...
<acme:form>
	...
	<acme:form-moment code="authenticated.task.form.label.startPeriod" path="startPeriod"/>
	<acme:form-moment code="authenticated.task.form.label.endPeriod" path="endPeriod"/>
