...
public class OfficerWorkPlanUpdateTest extends AcmePlannerTest {

	// En este test probaremos que se actualizan correctamente los planes de trabajo
	@ParameterizedTest
	@CsvFileSource(resources = "/officer/work-plan/update-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	public void updatePositive(final int recordIndex, final String title, final String startPeriod, final String endPeriod, final String workload, final String isPublic, final String dutySelected, final String dutyDeleteSelected) {
		...
		super.fillInputBoxIn("dutySelected", dutySelected);
		super.fillInputBoxIn("dutyDeleteSelected", dutyDeleteSelected);
	 ...
	 */
	@ParameterizedTest
	@CsvFileSource(resources = "/officer/work-plan/update-negative.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(20)
	public void updateNegative(final int recordIndex, final String title, final String startPeriod, final String endPeriod, final String workload, final String isPublic, final String dutySelected, final String dutyDeleteSelected) {
